...
class TestEmails(TestCase):
    """ This test class is launched to verify the mail's mecanism. """
    def setUp(self):
        """ This method prepares the initial test environment.
        It creates a User's instance
        """
        self.c = Client()
        self.a_user = User.objects.create_user(username="a_user", email="a_user@purebeurre.com", password="user.1234")

    def test_01_generic_send_email(self):
        """ This method checks if outbox is not empty after sending mail """
    ...
    def test_02_activation_account(self):
        """ This method checks
            - outbox is not empty after sending mail,
            - mail content,
        """
